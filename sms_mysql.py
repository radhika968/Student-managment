...
db_connection = mysql.connector.connect(host="localhost",user="root",password="sbit")  
...
class StudentApp(tk.Tk):  
    def __init__(self):  
        ...
        self.lblSelect = tk.Label(self, text="Please select one record below to update or delete", font=("Helvetica", 10),
                                bg="blue", fg="yellow")  
...
#return  
    ...
    def update_student_data(self):  
        ...
        DOB = self.calDOB.get()  
        print( roll_no)  
        Update = "Update student_master set fname='%s', lname='%s', mobileno='%s', city='%s', state='%s', dob='%s' where rollno='%s'" %(First_Name, Last_Name, Phone_Number, City, State,DOB, roll_no)  
